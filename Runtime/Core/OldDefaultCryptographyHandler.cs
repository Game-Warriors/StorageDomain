...
{
    /// <summary>
    /// This class provider encryption service by RijndaelManaged class and for hashing use HMACSHA256 class
    /// </summary>
    public class OldDefaultCryptographyHandler : ICryptographyHandler
    {
